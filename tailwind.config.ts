  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        // Aesthetic enhancements for gallery experience
        'badge-shimmer': {
      ...
      animation: {
        ...
        'badge-shimmer': 'badge-shimmer 1.5s ease-in-out 2s infinite',
        'ink-ripple': 'ink-ripple 600ms cubic-bezier(0.4, 0, 0.2, 1) forwards',
