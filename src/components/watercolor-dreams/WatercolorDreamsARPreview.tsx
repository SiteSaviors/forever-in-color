...
const WatercolorDreamsARPreview = () => {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="bg-gradient-to-br from-pink-50 to-orange-50 rounded-2xl p-8">
          ...
          <p className="text-gray-600 mb-6">
            Include a QR code that brings your Watercolor Dreams to life with a dynamic video when scanned with any smartphone.
          </p>
...
export default WatercolorDreamsARPreview;
