...
const WatercolorDreamsGallery = () => {
  ...
  const galleryImages = [
    ...
    {
      before: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=400&h=400&fit=crop",
      after: "/lovable-uploads/24492292-d190-4b8b-ab5b-edec02774b0b.png",
      type: "Landscape"
    },
    {
      before: "https://images.unsplash.com/photo-1518717758536-85ae29035b6d?w=400&h=400&fit=crop",
      after: "/lovable-uploads/24492292-d190-4b8b-ab5b-edec02774b0b.png",
      type: "Pet"
    }
  ];
        ...
        <div className="relative">
          <div className="flex justify-center">
            <div className="grid md:grid-cols-2 gap-8 items-center max-w-4xl">
              ...
              {/* After Image */}
              <div className="text-center">
                <h3 className="text-lg font-semibold mb-4 text-pink-700">Watercolor Dreams</h3>
                <div className="aspect-square rounded-lg overflow-hidden shadow-lg">
                  <img 
                    src={galleryImages[currentImageIndex].after}
                    alt="Watercolor Dreams style"
                    className="w-full h-full object-cover"
                  />
                </div>
              </div>
...
export default WatercolorDreamsGallery;
