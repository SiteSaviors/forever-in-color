...
const ClassicOilHero = ({ onStartCreating }: ClassicOilHeroProps) => {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <Button 
              ...
              className="bg-gradient-to-r from-amber-600 via-orange-700 to-red-800 text-white px-16 py-8 rounded-full text-2xl font-semibold hover:shadow-xl transform hover:scale-105 transition-all duration-300"
            >
