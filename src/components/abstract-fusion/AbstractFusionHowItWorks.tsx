...
const AbstractFusionHowItWorks = () => {
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">Select Abstract Fusion</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">Share your creative vision</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="font-semibold mb-2">Fuse Styles</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="font-semibold mb-2">Dynamic Art</h3>
            <p className="text-gray-600 text-sm">Ready to inspire & energize</p>
          </div>
        </div>
      </div>
    </section>
...
export default AbstractFusionHowItWorks;
