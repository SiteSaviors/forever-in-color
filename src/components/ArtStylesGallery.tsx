...
const ArtStylesGallery = () => {
  ...
  return <section id="styles" className="py-20 bg-white">
        ...
        <div className="relative">
          ...
          loop: true
            ...
            <CarouselContent className="-ml-2 md:-ml-4">
              {artStyles.map(style => <CarouselItem key={style.id} className="pl-2 md:pl-4 basis-full sm:basis-1/2 lg:basis-1/3">
                  <Card className="group relative overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border-2 hover:border-purple-200 h-full">
                    <CardContent className="p-0 h-full flex flex-col">
                      ...
                      <div className="relative h-80 overflow-hidden">
                        ...
                        {/* Popular Badge */}
                        {style.popular && <div className="absolute top-4 right-4">
