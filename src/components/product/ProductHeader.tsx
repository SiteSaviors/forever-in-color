    ...
    <div className="bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 border-b border-purple-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        ...
        <div className="flex items-center justify-center gap-6 mb-6">
          ...
          <div className="flex items-center gap-2 bg-blue-100/80 backdrop-blur-sm px-4 py-2 rounded-full border border-blue-200">
            <Timer className="w-4 h-4 text-blue-600" />
            <span className="text-blue-700 font-medium text-sm">{recentOrders} orders in last hour</span>
          </div>
        </div>
        ...
        <div className="text-center mb-8">
          ...
          <Button
            ...
            className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-4 text-lg font-bold rounded-full shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 mb-8"
          >
