    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-3">
          ...
          <div className="text-2xl font-bold text-green-800">{currentVisitors}</div>
          <div className="text-xs text-green-600">people viewing</div>
        </div>
        
        <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-lg p-3">
          <div className="flex items-center gap-2 mb-1">
            <ShoppingCart className="w-3 h-3 text-purple-600" />
            <span className="text-sm font-medium text-purple-700">Today</span>
          </div>
          <div className="text-2xl font-bold text-purple-800">{todayOrders}</div>
          <div className="text-xs text-purple-600">orders placed</div>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        {activities.map((activity) => {
          ...
          return (
            <div key={activity.id} className="flex items-center gap-3 py-2 px-3 bg-white rounded-lg border border-gray-100 hover:border-gray-200 transition-colors">
      ...
      <div className="bg-gray-50 rounded-lg p-3">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-sm font-medium text-gray-700">Popular Today</span>
        </div>
