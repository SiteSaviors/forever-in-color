    ...
    >
      ...
      <div className={`absolute inset-0 rounded-2xl transition-all duration-500 backdrop-blur-xl ${
        ...
        <div className={`absolute inset-0 rounded-2xl transition-opacity duration-500 ${
          isSelected 
            ? 'bg-gradient-to-br from-purple-600/10 via-transparent to-pink-600/10 opacity-100' 
            : 'bg-gradient-to-br from-gray-100/50 via-transparent to-gray-200/50 opacity-0 group-hover:opacity-100'
        }`} />
      </div>
      ...
      <div className="relative p-6 space-y-4">
        ...
        <div className="text-center space-y-2">
          <div className="bg-white/60 backdrop-blur-sm rounded-lg p-3 border border-white/30">
            <h5 className="font-bold text-lg text-gray-900 mb-1">{option.size}</h5>
      ...
      {isSelected && (
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-purple-500 via-pink-500 to-purple-500 p-0.5 opacity-50 animate-pulse">
