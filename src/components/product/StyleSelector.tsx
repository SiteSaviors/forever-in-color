...
const StyleSelector = ({
  ...
  return <div className="space-y-6">
      ...
      {croppedImage && onRecropImage && <div className="flex justify-center">
          <Button variant="outline" onClick={onRecropImage} className="bg-white hover:bg-gray-50 border-gray-300 text-gray-700 flex items-center gap-2 px-6 py-3 shadow-sm">
