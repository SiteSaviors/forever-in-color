...
const StyleSelector = ({
  ...
  return <div className="space-y-6">
      ...
      {croppedImage && onRecropImage && <div className="flex justify-center">
          
        </div>}

      {/* Crop Info & Recrop Option */}
      {croppedImage && onRecropImage && <div className="flex flex-col md:flex-row items-center justify-between gap-4 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-200">
          ...
          <Button variant="outline" size="sm" onClick={onRecropImage} className="bg-white hover:bg-blue-50 border-blue-300 text-blue-700 flex items-center gap-2">
