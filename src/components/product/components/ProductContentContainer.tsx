  ...
  return (
    <div className="relative bg-gradient-to-br from-slate-900 via-violet-900 to-fuchsia-900 min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-10 w-48 h-48 bg-gradient-to-br from-cyan-300/20 to-violet-400/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute top-40 right-20 w-36 h-36 bg-gradient-to-br from-fuchsia-300/25 to-rose-400/25 rounded-full blur-2xl animate-pulse delay-1000" />
