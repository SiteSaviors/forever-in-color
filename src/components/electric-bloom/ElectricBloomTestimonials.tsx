...
const ElectricBloomTestimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      quote: "This style perfectly captures that futuristic aesthetic I was looking for. The neon aura effect makes it look like my photo is electrified - absolutely stunning for my modern apartment.",
