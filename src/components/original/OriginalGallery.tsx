  ...
  const galleryImages = [
    {
      ...
      after: "/lovable-uploads/7c213c30-aab4-4e71-a805-9cfdbec2a5dd.png",
      type: "Portrait"
    },
    {
  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">See the Quality</h2>
...
export default OriginalGallery;
