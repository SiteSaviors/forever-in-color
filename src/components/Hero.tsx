          ...
          <div className="relative h-[600px] lg:h-[700px]">
            ...
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-full">
              ...
              <div className="absolute -right-16 sm:-right-20 top-8 transform rotate-12 z-10">
                <div className="bg-white rounded-3xl shadow-2xl p-4 sm:p-6 w-48 h-56 sm:w-64 sm:h-72">
                  <div className="aspect-square bg-gradient-to-br from-cyan-200 via-blue-200 to-purple-200 rounded-2xl mb-4 overflow-hidden">
                    <img 
              ...
              {/* Frame 4 - Bottom Left Position - MOVED DOWN FURTHER & SAME SIZE */}
              <div className="absolute -left-16 sm:-left-20 top-80 sm:top-96 transform -rotate-12 z-15">
                <div className="bg-white rounded-3xl shadow-2xl p-4 sm:p-6 w-48 h-56 sm:w-64 sm:h-72">
              ...
              {/* Frame 5 - Bottom Right Position - MOVED DOWN FURTHER & SAME SIZE */}
              <div className="absolute -right-16 sm:-right-20 top-80 sm:top-96 transform rotate-12 z-15">
                <div className="bg-white rounded-3xl shadow-2xl p-4 sm:p-6 w-48 h-56 sm:w-64 sm:h-72">
