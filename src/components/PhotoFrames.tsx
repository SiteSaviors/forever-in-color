...
const PhotoFrames = () => {
  return <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-full max-w-sm sm:max-w-none">
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2 -top-12 sm:-top-8 rotate-3 z-20">
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-2 sm:p-6 w-24 h-32 sm:w-64 sm:h-72">
      ...
      <div className="absolute left-4 sm:-left-20 top-40 sm:top-72 transform -rotate-12 z-15">
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-2 sm:p-6 w-24 h-32 sm:w-64 sm:h-72">
          ...
          <div className="flex justify-between items-center">
            <div className="text-[8px] sm:text-sm font-medium text-gray-600">Classic Oil Painting</div>
            <div className="flex space-x-0.5 sm:space-x-1">
      ...
      <div className="absolute right-4 sm:-right-20 top-40 sm:top-72 transform rotate-12 z-15">
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-2 sm:p-6 w-24 h-32 sm:w-64 sm:h-72">
          ...
          <div className="flex justify-between items-center">
            <div className="text-[8px] sm:text-sm font-medium text-gray-600">Abstract Fusion</div>
            <div className="flex space-x-0.5 sm:space-x-1">
