...
const TIER_RECOMMENDATIONS: Record<EntitlementTier, RecommendationData | null> = {
  ...
  creator: {
    ...
    price: '$19.99/month',
    reason: 'You\'re using tokens consistently. Plus gives you 3x more with batch export tools',
    savings: 'Ideal for client work',
  },
  plus: {
    recommendedTier: 'Pro',
    currentQuota: 150,
    recommendedQuota: 400,
    price: '$49.99/month',
    reason: 'Scale to Pro for 400 tokens/month and white-glove concierge support',
