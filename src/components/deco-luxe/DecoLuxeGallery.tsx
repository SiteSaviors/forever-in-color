  ...
  const galleryImages = [
    {
      ...
      after: "/lovable-uploads/538dcdf0-4fce-48ea-be55-314d68926919.png",
      type: "Portrait"
    },
    {
        ...
        <div className="relative">
          <div className="flex justify-center">
            <div className="grid md:grid-cols-2 gap-8 items-center max-w-4xl">
              ...
              {/* After Image */}
              <div className="text-center">
                <h3 className="text-lg font-semibold mb-4 text-amber-600">Deco Luxe</h3>
                <div className="aspect-square rounded-lg overflow-hidden shadow-lg">
                  <img 
            ...
            {galleryImages.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-colors ${
                  index === currentImageIndex ? 'bg-amber-500' : 'bg-gray-300'
                }`}
              />
            ))}
          </div>
