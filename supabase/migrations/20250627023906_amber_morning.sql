/*
  # Fix style_prompts table and insert prompts

  1. Changes
    - Add IF NOT EXISTS to table creation
    - Use ON CONFLICT for style_id to handle existing records
    - Maintain all original prompts
  2. Security
...
-- Insert your custom prompts with conflict handling
