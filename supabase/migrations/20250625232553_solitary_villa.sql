...
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'style_prompts') THEN
...
-- Truncate the table to ensure we have a clean slate for our prompts
TRUNCATE TABLE public.style_prompts;

-- Insert your custom prompts
INSERT INTO public.style_prompts (style_id, prompt) VALUES
